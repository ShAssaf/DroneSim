...
class GeoJsonParser:
    ...
    @staticmethod
    def get_geojson_from_data(path='../data/geojson/new_york1.geojson'):
    ...
    @staticmethod
    def plot_map(building):
        m = GeoJsonParser.create_boarder_for_plotting(a.get_map_border_from_geo_list())
    ...
    def plot_heat_map(self):
        ...
        b_map = GeoJsonParser.create_boarder_for_plotting(a.get_map_border_from_geo_list())
